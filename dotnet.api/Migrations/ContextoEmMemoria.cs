...
namespace dotnet.api.ContextoDados
{
    public class ContextoEmMemoria : IContextoDados
    {
        ...
        public IQueryable<OnibusModel> OnibusModel
        {
            get { return onibusModel.AsQueryable(); }
        }
        ...
        private static List<TModel> ObterModelosPelo<TModel>()
        {
            ...
            if (tipo == typeof(OnibusModel))
            {
                return onibusModel as List<TModel>;
            }
        ...
        {
            onibusModel = new List<OnibusModel>();
            onibusModel.AddRange(new List<OnibusModel>
            { 

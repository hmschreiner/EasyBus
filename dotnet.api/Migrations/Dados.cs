        ...
        public static OnibusModel[] Onibus
        {
            get
            {
                return new OnibusModel[] { 
                    ...
                    new OnibusModel{ Nome = "A. FEIJO/HUMAITA/JOAO PARIS", Codigo = "B251", OnibusID = 127903, Notifica = false}, 
                    new OnibusModel{ Nome = "A. FEIJO/JOAO PARIS/HUMAITA", Codigo = "B252", OnibusID = 127904, Notifica = false}, 
                    new OnibusModel{ Nome = "VILA FARRAPOS", Codigo = "703", OnibusID = 128079, Notifica = false}, 

                    new OnibusModel{ Nome = "HUMAITA", Codigo = "704", OnibusID = 128082, Notifica = false}, 
                    new OnibusModel{ Nome = "HUMAITA/A.J.RENNER/DONA TEODORA", Codigo = "7041", OnibusID = 128084, Notifica = false},

                    new OnibusModel{ Nome = "BAIRRO ANCHIETA", Codigo = "702", OnibusID = 128078, Notifica = false},
                    new OnibusModel{ Nome = "AEROPORTO/IGUATEMI", Codigo = "B09", OnibusID = 128093, Notifica = false},
                    new OnibusModel{ Nome = "AEROPORTO/IGUATEMI/ANCHIETA", Codigo = "B091", OnibusID = 128094, Notifica = false},
                };
            }
        }
